...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/CSS/proyecto.css">
...
<?php endif; ?>
    ...
    <br>
        <div class="fondo_gradiente" style="padding-top: 50px;">
            <div class="texto" id="nosotros">
                <h1><b>Mapa de sitio</b></h1><br>
                <img src="/Documentation/GUI/SisteMap/SisteMap-OneMoreLight.png" height="400px">
            </div>
        </div>
    </main>
